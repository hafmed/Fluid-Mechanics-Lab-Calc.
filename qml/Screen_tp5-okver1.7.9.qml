            ...
            StackLayout {
                ...
                Column {
                    ...
                    TabBar {
                        ...
                        onCurrentIndexChanged: tableModel1_tp5.updatechart1_venturie_tp5();
                    }
                    StackLayout {
                        id: view2_tp4
                        width: parent.width
                            ...
                            Rectangle {
                                ...
                                TableView {
                                    ...
                                    model: TableModel {
                                        ...
                                        {
                                            ///-------------------------
                                            dh1tableModel1_tp5=tableModel1_tp5.rows[2].DH
                                            dh2tableModel1_tp5=tableModel1_tp5.rows[3].DH
                                            dh3tableModel1_tp5=tableModel1_tp5.rows[4].DH

                                            var s1=3.14*d1_tp5*0.001*d1_tp5*0.001/4
                                            var s2=3.14*d2_tp5*0.001*d2_tp5*0.001/4

                                            qtheo1tableModel1_tp5=(s1*s2)*Math.sqrt(2*9.81*dh1tableModel1_tp5*0.001)/Math.sqrt(s1*s1-s2*s2)
                                            qtheo2tableModel1_tp5=(s1*s2)*Math.sqrt(2*9.81*dh2tableModel1_tp5*0.001)/Math.sqrt(s1*s1-s2*s2)
                                            qtheo3tableModel1_tp5=(s1*s2)*Math.sqrt(2*9.81*dh3tableModel1_tp5*0.001)/Math.sqrt(s1*s1-s2*s2)

                                            qtheo1tableModel1_tp5=(qtheo1tableModel1_tp5*1000).toFixed(3)
                                            qtheo2tableModel1_tp5=(qtheo2tableModel1_tp5*1000).toFixed(3)
                                            qtheo3tableModel1_tp5=(qtheo3tableModel1_tp5*1000).toFixed(3)

                                            cd1_tp5=tableModel1_tp5.rows[2].Qexp/qtheo1tableModel1_tp5
                                            cd2_tp5=tableModel1_tp5.rows[3].Qexp/qtheo2tableModel1_tp5
                                            cd3_tp5=tableModel1_tp5.rows[4].Qexp/qtheo3tableModel1_tp5

                                            tableModel1_tp5.setRow(2, {Qexp:tableModel1_tp5.rows[2].Qexp,DH:tableModel1_tp5.rows[2].DH,Qtheo:qtheo1tableModel1_tp5.toFixed(3),Cd:cd1_tp5.toFixed(3),})
                                            tableModel1_tp5.setRow(3, {Qexp:tableModel1_tp5.rows[3].Qexp,DH:tableModel1_tp5.rows[3].DH,Qtheo:qtheo2tableModel1_tp5.toFixed(3),Cd:cd2_tp5.toFixed(3),})
                                            tableModel1_tp5.setRow(4, {Qexp:tableModel1_tp5.rows[4].Qexp,DH:tableModel1_tp5.rows[4].DH,Qtheo:qtheo3tableModel1_tp5.toFixed(3),Cd:cd3_tp5.toFixed(3),})
                                            ...
                                            var maxQtheo=parseFloat(tableModel1_tp5.rows[2].Qtheo);
                                            var maxQexp=parseFloat(tableModel1_tp5.rows[2].Qexp);
                                            var miniQtheo=parseFloat(tableModel1_tp5.rows[2].Qtheo);
                                            var miniQexp=parseFloat(tableModel1_tp5.rows[2].Qexp);
                                            for (var i = 2; i < tableModel1_tp5.rowCount; i++)  {
                                                if (tableModel1_tp5.rows[i].Qtheo > maxQtheo)
                                                    maxQtheo=parseFloat(tableModel1_tp5.rows[i].Qtheo) ;
                                                if (tableModel1_tp5.rows[i].Qexp > maxQexp)
                                                    maxQexp=parseFloat(tableModel1_tp5.rows[i].Qexp) ;
                                                if (tableModel1_tp5.rows[i].Qtheo < miniQtheo)
                                                    miniQtheo=parseFloat(tableModel1_tp5.rows[i].Qtheo) ;
                                                if (tableModel1_tp5.rows[i].Qexp < miniQexp)
                                                    miniQexp=parseFloat(tableModel1_tp5.rows[i].Qexp) ;
                                            }
                                            for (i = 2; i < tableModel1_tp5.rowCount; i++)  {
                                                if (tableModel1_tp5.rows[i].Qexp!==0
                                                        && tableModel1_tp5.rows[i].Qtheo!==""
                                                        )
                                                    line.append(tableModel1_tp5.rows[i].Qexp,tableModel1_tp5.rows[i].Qtheo)
                                            }
                                        ...
                                        rows: [
                                            ...
                                            {
                                                Qexp: settings.qexp1tableModel1_tp5,
                                                DH: settings.dh1tableModel1_tp5,
                                                Qtheo: settings.qtheo1tableModel1_tp5,
                                                Cd: settings.cd1tableModel1_tp5,
                                            },
                                            {
                                                Qexp: settings.qexp2tableModel1_tp5,
                                                DH: settings.dh2tableModel1_tp5,
                                                Qtheo: settings.qtheo2tableModel1_tp5,
                                                Cd: settings.cd2tableModel1_tp5,
                                            },
                                            {
                                                Qexp: settings.qexp3tableModel1_tp5,
                                                DH: settings.dh3tableModel1_tp5,
                                                Qtheo: settings.qtheo3tableModel1_tp5,
                                                Cd: settings.cd3tableModel1_tp5,
                                            }
                                        ]
                                    }
                                    delegate: DelegateChooser {
                                        DelegateChoice {
                                            ...
                                            delegate: Button {
                                                ...
                                                onClicked:{
                                                    ...
                                                    console.log("clicked"+tableModel1_tp5.rows[index].DH+":"+index)
                                                    indexqexpMoy=index
                                                }
                                            }
                                        }
                                        DelegateChoice {
                                            ...
                                            delegate: TextField {
                                                ...
                                                onAccepted: {
                                                    ///console.log("clicked"+tableModel1_tp5.rows[index].Qtheo+":"+index)
                                    ...
                                    Dialog {
                                        ...
                                        onAccepted: {
                                            ...
                                            tableModel1_tp5.setRow(indexqexpMoy, {Qexp:qexpMoy,DH:tableModel1_tp5.rows[indexqexpMoy].DH,Qtheo:tableModel1_tp5.rows[indexqexpMoy].Qtheo,Cd:tableModel1_tp5.rows[indexqexpMoy].Cd,})
                                            if (indexqexpMoy==2) qexp1tableModel1_tp5=qexpMoy
                                            if (indexqexpMoy==3) qexp2tableModel1_tp5=qexpMoy
                                            if (indexqexpMoy==4) qexp3tableModel1_tp5=qexpMoy
                                            close()
                                        }
                                    }
                                }
                            ...
                            Rectangle {
                                ...
                                TableView {
                                    ...
                                    model: TableModel {
                                        ...
                                        {
                                            ///-------------------------
                                            dh1tableModel1_Diaphra_tp5=tableModel1_Diaphra_tp5.rows[2].DH
                                            dh2tableModel1_Diaphra_tp5=tableModel1_Diaphra_tp5.rows[3].DH
                                            dh3tableModel1_Diaphra_tp5=tableModel1_Diaphra_tp5.rows[4].DH
                                            ...
                                            cd1_Diaphra_tp5=tableModel1_Diaphra_tp5.rows[2].Qexp/qtheo1tableModel1_Diaphra_tp5
                                            cd2_Diaphra_tp5=tableModel1_Diaphra_tp5.rows[3].Qexp/qtheo2tableModel1_Diaphra_tp5
                                            cd3_Diaphra_tp5=tableModel1_Diaphra_tp5.rows[4].Qexp/qtheo3tableModel1_Diaphra_tp5

                                            tableModel1_Diaphra_tp5.setRow(2, {Qexp:tableModel1_Diaphra_tp5.rows[2].Qexp,DH:tableModel1_Diaphra_tp5.rows[2].DH,Qtheo:qtheo1tableModel1_Diaphra_tp5.toFixed(3),Cd:cd1_Diaphra_tp5.toFixed(3),})
                                            tableModel1_Diaphra_tp5.setRow(3, {Qexp:tableModel1_Diaphra_tp5.rows[3].Qexp,DH:tableModel1_Diaphra_tp5.rows[3].DH,Qtheo:qtheo2tableModel1_Diaphra_tp5.toFixed(3),Cd:cd2_Diaphra_tp5.toFixed(3),})
                                            tableModel1_Diaphra_tp5.setRow(4, {Qexp:tableModel1_Diaphra_tp5.rows[4].Qexp,DH:tableModel1_Diaphra_tp5.rows[4].DH,Qtheo:qtheo3tableModel1_Diaphra_tp5.toFixed(3),Cd:cd3_Diaphra_tp5.toFixed(3),})
                                            ...
                                            var maxQtheo_Diaphra=parseFloat(tableModel1_Diaphra_tp5.rows[2].Qtheo);
                                            var maxQexp_Diaphra=parseFloat(tableModel1_Diaphra_tp5.rows[2].Qexp);
                                            var miniQtheo_Diaphra=parseFloat(tableModel1_Diaphra_tp5.rows[2].Qtheo);
                                            var miniQexp_Diaphra=parseFloat(tableModel1_Diaphra_tp5.rows[2].Qexp);
                                            for (var i = 2; i < tableModel1_Diaphra_tp5.rowCount; i++)  {
                                            ...
                                            for (i = 2; i < tableModel1_Diaphra_tp5.rowCount; i++)  {
                                        ...
                                        rows: [
                                            ...
                                            {
                                                Qexp: settings.qexp1tableModel1_Diaphra_tp5,
                                                DH: settings.dh1tableModel1_Diaphra_tp5,
                                                Qtheo: settings.qtheo1tableModel1_Diaphra_tp5,
                                                Cd: settings.cd1tableModel1_Diaphra_tp5,
                                            },
                                            {
                                                Qexp: settings.qexp2tableModel1_Diaphra_tp5,
                                                DH: settings.dh2tableModel1_Diaphra_tp5,
                                                Qtheo: settings.qtheo2tableModel1_Diaphra_tp5,
                                                Cd: settings.cd2tableModel1_Diaphra_tp5,
                                            },
                                            {
                                                Qexp: settings.qexp3tableModel1_Diaphra_tp5,
                                                DH: settings.dh3tableModel1_Diaphra_tp5,
                                                Qtheo: settings.qtheo3tableModel1_Diaphra_tp5,
                                                Cd: settings.cd3tableModel1_Diaphra_tp5,
                                            }
                                        ]
                                    }
                                    delegate: DelegateChooser {
