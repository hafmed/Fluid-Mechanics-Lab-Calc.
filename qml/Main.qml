...
Item {
    ...
    Settings {
        ...
        property real qexp1tableModel1_tp5
        property real dh1tableModel1_tp5
        property real qtheo1tableModel1_tp5
        property real cd1tableModel1_tp5
        property real qexp2tableModel1_tp5
        property real dh2tableModel1_tp5
        property real qtheo2tableModel1_tp5
        property real cd2tableModel1_tp5

        property real qexp3tableModel1_tp5
        property real dh3tableModel1_tp5
        property real qtheo3tableModel1_tp5
        property real cd3tableModel1_tp5
    ...
    property real temperatableModel1_tp1:20
    property real temperatableModel2_tp1:25
    property real temperatableModel3_tp1:35
    property real viscodynamesurtableModel1_tp1:5.59
    property real viscodynamesurtableModel2_tp1:4.51
    property real viscodynamesurtableModel3_tp1:3.51
    ...
    property real pressuretableModel1_tp3:40.072
    property real pressuretableModel2_tp3:60.108
    property real pressuretableModel3_tp3:80.144
    property real pressuretableModel4_tp3:100.181
    property real pressuretableModel5_tp3:120.217
    property real tensiontableModel1_tp3:14.6
    property real tensiontableModel2_tp3:21.6
    property real tensiontableModel3_tp3:30
    property real tensiontableModel4_tp3:38
    property real tensiontableModel5_tp3:47
    property real degreestableModel1_tp3:50
    property real degreestableModel2_tp3:77
    property real degreestableModel3_tp3:100
    property real degreestableModel4_tp3:125
    property real degreestableModel5_tp3:151
    ...
    property real qexp1tableModel1_tp5:0.306
    property real dh1tableModel1_tp5:75
    property real qtheo1tableModel1_tp5
    property real cd1tableModel1_tp5
    property real qexp2tableModel1_tp5:0.462
    property real dh2tableModel1_tp5:195
    property real qtheo2tableModel1_tp5
    property real cd2tableModel1_tp5

    property real qexp3tableModel1_tp5:0.639
    property real dh3tableModel1_tp5:310
    property real qtheo3tableModel1_tp5
    property real cd3tableModel1_tp5
    ...
    property real qexp1tableModel1_Diaphra_tp5:0.283
    property real dh1tableModel1_Diaphra_tp5:60
    property real qtheo1tableModel1_Diaphra_tp5
    property real cd1tableModel1_Diaphra_tp5
    property real qexp2tableModel1_Diaphra_tp5:0.500
    property real dh2tableModel1_Diaphra_tp5:205
    property real qtheo2tableModel1_Diaphra_tp5
    property real cd2tableModel1_Diaphra_tp5

    property real qexp3tableModel1_Diaphra_tp5:0.559
    property real dh3tableModel1_Diaphra_tp5:250
    property real qtheo3tableModel1_Diaphra_tp5
    property real cd3tableModel1_Diaphra_tp5
    ...
    function savesettings() {
        ...
        settings.qexp1tableModel1_tp5=qexp1tableModel1_tp5
        settings.dh1tableModel1_tp5=dh1tableModel1_tp5
        settings.qtheo1tableModel1_tp5=qtheo1tableModel1_tp5
        settings.cd1tableModel1_tp5=cd1tableModel1_tp5
        settings.qexp2tableModel1_tp5=qexp2tableModel1_tp5
        settings.dh2tableModel1_tp5=dh2tableModel1_tp5
        settings.qtheo2tableModel1_tp5=qtheo2tableModel1_tp5
        settings.cd2tableModel1_tp5=cd2tableModel1_tp5

        settings.qexp3tableModel1_tp5=qexp3tableModel1_tp5
        settings.dh3tableModel1_tp5=dh3tableModel1_tp5
        settings.qtheo3tableModel1_tp5=qtheo3tableModel1_tp5
        settings.cd3tableModel1_tp5=cd3tableModel1_tp5
    ...
    function loadsettings() {
        ...
        qexp1tableModel1_tp5=settings.qexp1tableModel1_tp5
        dh1tableModel1_tp5=settings.dh1tableModel1_tp5
        qtheo1tableModel1_tp5=settings.qtheo1tableModel1_tp5
        cd1tableModel1_tp5=settings.cd1tableModel1_tp5

        qexp2tableModel1_tp5=settings.qexp2tableModel1_tp5
        dh2tableModel1_tp5=settings.dh2tableModel1_tp5
        qtheo2tableModel1_tp5=settings.qtheo2tableModel1_tp5
        cd2tableModel1_tp5=settings.cd2tableModel1_tp5

        qexp3tableModel1_tp5=settings.qexp3tableModel1_tp5
        dh3tableModel1_tp5=settings.dh3tableModel1_tp5
        qtheo3tableModel1_tp5=settings.qtheo3tableModel1_tp5
        cd3tableModel1_tp5=settings.cd3tableModel1_tp5
    ...
    function loaddefaultsettings() {
       /// firstuseofapp=true
        ...
        qexp1tableModel1_tp5=0.306
        dh1tableModel1_tp5=75
        qtheo1tableModel1_tp5=0
        cd1tableModel1_tp5=0

        qexp2tableModel1_tp5=0.462
        dh2tableModel1_tp5=195
        qtheo2tableModel1_tp5=0
        cd2tableModel1_tp5=0

        qexp3tableModel1_tp5=0.639
        dh3tableModel1_tp5=310
        qtheo3tableModel1_tp5=0
        cd3tableModel1_tp5=0
