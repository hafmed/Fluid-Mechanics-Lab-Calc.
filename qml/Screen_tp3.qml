        ...
        Column {
            ...
            Row {
                ...
                TextField {
                    ...
                    placeholderText: qsTr("Degre Bourdon Gauge")
                    ...
                    TableView {
                        ...
                        model: TableModel {
                            ...
                            function updatechart1_tp3()
                            {
                                ...
                                var maxPressure=parseFloat(tableModel1_tp3.rows[2].Pressure);
                                var maxDegrees=parseFloat(tableModel1_tp3.rows[2].Degrees);
                                var maxTension=parseFloat(tableModel1_tp3.rows[2].Tension);

                                var miniPressure=parseFloat(tableModel1_tp3.rows[2].Pressure);
                                var miniDegrees=parseFloat(tableModel1_tp3.rows[2].Degrees);
                                var miniTension=parseFloat(tableModel1_tp3.rows[2].Tension);

                                for (var i = 2; i < tableModel1_tp3.rowCount; i++)  {
                                ...
                                for (i = 2; i < tableModel1_tp3.rowCount; i++)  {
                                ...
                                pressuretableModel1_tp3=tableModel1_tp3.rows[2].Pressure
                                pressuretableModel2_tp3=tableModel1_tp3.rows[3].Pressure
                                pressuretableModel3_tp3=tableModel1_tp3.rows[4].Pressure
                                pressuretableModel4_tp3=tableModel1_tp3.rows[5].Pressure
                                pressuretableModel5_tp3=tableModel1_tp3.rows[6].Pressure

                                degreestableModel1_tp3=tableModel1_tp3.rows[2].Degrees
                                degreestableModel2_tp3=tableModel1_tp3.rows[3].Degrees
                                degreestableModel3_tp3=tableModel1_tp3.rows[4].Degrees
                                degreestableModel4_tp3=tableModel1_tp3.rows[5].Degrees
                                degreestableModel5_tp3=tableModel1_tp3.rows[6].Degrees

                                tensiontableModel1_tp3=tableModel1_tp3.rows[2].Tension
                                tensiontableModel2_tp3=tableModel1_tp3.rows[3].Tension
                                tensiontableModel3_tp3=tableModel1_tp3.rows[4].Tension
                                tensiontableModel4_tp3=tableModel1_tp3.rows[5].Tension
                                tensiontableModel5_tp3=tableModel1_tp3.rows[6].Tension
                            }
                            rows: [
                                {
                                    Pressure: "P",
                                ...
                                {
                                    Pressure: settings.pressuretableModel1_tp3,
                                    Degrees: settings.degreestableModel1_tp3,
                                    Tension: settings.tensiontableModel1_tp3,
                                },
                                {
                                    Pressure: settings.pressuretableModel2_tp3,
                                    Degrees: settings.degreestableModel2_tp3,
                                    Tension: settings.tensiontableModel2_tp3,
                                },
                                {
                                    Pressure: settings.pressuretableModel3_tp3,
                                    Degrees: settings.degreestableModel3_tp3,
                                    Tension: settings.tensiontableModel3_tp3,
                                },
                                {
                                    Pressure: settings.pressuretableModel4_tp3,
                                    Degrees: settings.degreestableModel4_tp3,
                                    Tension: settings.tensiontableModel4_tp3,
                                },
                                {
                                    Pressure: settings.pressuretableModel5_tp3,
                                    Degrees: settings.degreestableModel5_tp3,
                                    Tension: settings.tensiontableModel5_tp3,
                                }
                            ]
                        }
                        delegate:  TextInput {
