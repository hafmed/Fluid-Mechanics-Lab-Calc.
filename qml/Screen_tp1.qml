                    ...
                    TableView {
                        ...
                        model: TableModel {
                            ...
                            function updatechart()
                            {
                                ...
                                var maxvisco=parseFloat(tableModel.rows[2].Viscodynamique);
                                var maxtemperature=parseFloat(tableModel.rows[2].Temperature);
                                var minivisco=parseFloat(tableModel.rows[2].Viscodynamique);
                                var minitemperature=parseFloat(tableModel.rows[2].Temperature);
                                for (var i = 2; i < tableModel.rowCount; i++)  {
                                    if (tableModel.rows[i].Viscodynamique > maxvisco)
                                        maxvisco=parseFloat(tableModel.rows[i].Viscodynamique) ;
                                    if (tableModel.rows[i].Temperature > maxtemperature)
                                        maxtemperature=parseFloat(tableModel.rows[i].Temperature) ;
                                    if (tableModel.rows[i].Viscodynamique < minivisco)
                                        minivisco=parseFloat(tableModel.rows[i].Viscodynamique) ;
                                    if (tableModel.rows[i].Temperature < minitemperature)
                                        minitemperature=parseFloat(tableModel.rows[i].Temperature) ;
                                }
                                for (i = 2; i < tableModel.rowCount; i++)  {
                                    if (tableModel.rows[i].Temperature!==0
                                            && tableModel.rows[i].Viscodynamique!==""
                                        ///    && tableModel.rows[i].Viscodynamique!==""
                                        ///    && tableModel.rows[i].Viscodynamique!==""
                                            )
                                        line.append(tableModel.rows[i].Temperature,tableModel.rows[i].Viscodynamique)
                                }
                                ...
                                temperatableModel1_tp1=tableModel.rows[2].Temperature
                                temperatableModel2_tp1=tableModel.rows[3].Temperature
                                temperatableModel3_tp1=tableModel.rows[4].Temperature
                                viscodynamesurtableModel1_tp1=tableModel.rows[2].Viscodynamique
                                viscodynamesurtableModel2_tp1=tableModel.rows[3].Viscodynamique
                                viscodynamesurtableModel3_tp1=tableModel.rows[4].Viscodynamique
                            }
                            rows: [
                                {
                                    Temperature: "T",
                                ...
                                {
                                    Temperature: "°C",
                                    Viscodynamique: "mPa.s",
                                },
                                {
                                    Temperature: settings.temperatableModel1_tp1,
                                    Viscodynamique: settings.viscodynamesurtableModel1_tp1,
                                },
                                {
                                    Temperature: settings.temperatableModel2_tp1,
                                    Viscodynamique: settings.viscodynamesurtableModel2_tp1,
                                },
                                {
                                    Temperature:settings.temperatableModel3_tp1,
                                    Viscodynamique: settings.viscodynamesurtableModel3_tp1,
                                }
                            ]
                        }
                        delegate:  TextInput {
